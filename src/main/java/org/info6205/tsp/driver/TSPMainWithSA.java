    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < 15; i++) {
                ...
                SimulatedAnnealing simulatedAnnealing = new SimulatedAnnealing(tspTour, 51200000, 3200, 0.5);
                List<Vertex> optimizedSATour = simulatedAnnealing.optimize();

                double optimizedSATourCost = GraphUtil.getTotalCostOfTour(optimizedSATour);

                if(bestCostYet > optimizedSATourCost){
                    bestTourYet = optimizedSATour;
                    bestCostYet = optimizedSATourCost;
                }
            }
            ...
            postProcess.start(bestTourYet, "christofidesOutputWithSA.csv");
